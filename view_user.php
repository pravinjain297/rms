...
//                            mysqli_query($con,"SET CHARACTER SET 'utf8'");
  //                          mysqli_query($con,"SET SESSION collation_connection ='utf8_unicode_ci'");
                        ...
                        <tr>
                         <td> ';echo$i++; echo'</td>
                          <td>id_'.$data["user_id"].'</td>
                          <td>'.$data["user_name"].'</td>
                          <td>'.$data["user_mobile_no"].'</td>
                          <td><label class="">'.$data["user_email_id"].'</label></td>
                          <td><label class="">'.$data["user_address"].'</label></td>
                          <td><label class="">'.$data["user_date"].'</label></td>
                          <td><label class="">'.$data["user_loan_amt"].'</label></td>
                          
                          <td style="font-size: 16px;">
                          <a href="edit_user.php?user_id='.$data["user_id"].'">
                          <i class="fas fa-edit " style="color: green" ></i>
                          
                          <a href="edit_user.php?user_id='.$data["user_id"].'">
                          <i class="fas fa-eye " style="color: blue" ></i>
                          
                           <a href="javascript:;" class="del" data-userid = '.$data["user_id"].'><i class="fas fa-trash" style="color: red"></i></a>
